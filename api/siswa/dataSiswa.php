...
$sql = "SELECT tb_siswa.*, tb_kelas.NamaKelas_ FROM (( tb_siswa INNER JOIN tb_kelas ON tb_siswa.IDKelas_ = tb_kelas.IDKelas_) ) WHERE 1=1 $cond ORDER BY tb_siswa.Nis_ ASC LIMIT $start, $limit";
