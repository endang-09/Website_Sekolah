...
if(isset($_GET['idnilai']) && !empty($_GET['idnilai'])) {
    ...
    $sql = "SELECT tb_nilai.*, tb_siswa.Nis_, tb_siswa.NamaSiswa_, tb_siswa.Alamat_, tb_mapel.NamaMapel_, tb_mapel.Kkm_, tb_siswa.IDKelas_, tb_kelas.NamaKelas_
    FROM ((( tb_nilai 
...
<body width="100%">
     <div class="title" align="center">Hasil Penilaian Belajar Siswa</div>
    <br><br>
